...
Colours["WindowBg"]               = ImVec4(0.1, 0.1, 0.1, 0.95);
...
Colours["ResizeGrip"]             = ImVec4(0.1, 0.1, 0.1, 0.85);
Colours["ResizeGripHovered"]      = ImVec4(0.3, 0.3, 0.3, 0.60);
Colours["ResizeGripActive"]       = ImVec4(0.2, 0.2, 0.2, 0.90);
